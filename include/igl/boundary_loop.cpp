...
template void igl::boundary_loop<Eigen::Matrix<int, -1, -1, 0, -1, -1>, long>(Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> > const&, std::vector<std::vector<long, std::allocator<long> >, std::allocator<std::vector<long, std::allocator<long> > > >&);
#endif
